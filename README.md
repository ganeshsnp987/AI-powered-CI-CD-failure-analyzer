...
Automatically analyzes GitHub Actions failures using Gemini and posts a root-cause diagnosis as a PR comment.

## Setup

1. Add `GEMINI_API_KEY` to your repo's **Settings → Secrets and variables → Actions**
...
4. Sends it to Gemini with a structured prompt
